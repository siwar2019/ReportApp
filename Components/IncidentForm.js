        ...
        return (
            <Container>
                ...
                <ScrollView style={{flex: 1, padding: 6}}>
                    <Text style={[styles.textColor]}>Vestibulum a tempor diam. Nullam tempus nibh ut consequat eleifend.
                        Nam sed sem fringilla tellus condimentum gravida sit amet ac magna.
                    </Text>
                ...
                >
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            ...
                            <Text style={styles.textColor}>Please choose an option:</Text>
